...
from DV1_DEFS import * # This line imports a set of simple definitions CNTRL_R_LITE_DEFS.py to make this file easier to read + customize.
...
N_TRACKS = 8 # How many tracks wide the red box should be. 4 is suggested if you want to use your CNTRL:R's 4x4 Grid
N_SCENES = 1 # How many scenes deep the red box should be. 4 is suggested if you want to use your CNTRL:R's 4x4 Grid
...
TRACK_CLIP_BUTTONS = [92,93,94,95,88,89,90,91] # Must be N_TRACKS x N_SCENES in length
...
USE_SENDS = True
N_SENDS_PER_TRACK = 2 # sends per track
SEND_ENCODERS = [24,28,25,29,26,30,27,31,40,44,41,45,42,46,43,47] 
...
VOLUME_ENCODERS = [20,21,22,23,36,37,38,39]
############################
